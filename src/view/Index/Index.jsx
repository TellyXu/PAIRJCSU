...
import r1 from "../../assets/view/r1.png"
import r2 from "../../assets/view/r2.png"
import r3 from "../../assets/view/r3.png"
import r4 from "../../assets/view/r4.png"
            ...
            <main className="text-white">
                ...
                <div className="relative bg-opacity-15 lg:pt-10 pb-12 pt-12" style={{ background: "#f3f3f3" }}>
                    ...
                    <div className="w-11/12 relative z-20 text-center mx-auto text-black">
                        ...
                        <div className='mt-12 lg:grid lg:grid-cols-2 gap-x-10 gap-y-10'>
                            <div className='w-full bg-white mb-10 lg:mb-0'>
                                <div className='relative'>
                                    <img className='w-full' src={r1} alt="AI for Cardiometabolic Health Research Scholars" />
                                    <div className='absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 text-white'>
                                        <p className='text-2xl font-bold'>AI for Cardiometabolic Health Research Scholars</p>
                                        <p className='text-lg'>Tomorrow's Innovators</p>
                                    </div>
                                </div>
                            </div>
                            <div className='w-full bg-white mb-10 lg:mb-0'>
                                <div className='relative'>
                                    <img className='w-full' src={r2} alt="JCSU Health/Career Fair" />
                                    <div className='absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 text-white'>
                                        <p className='text-2xl font-bold'>JCSU Health/Career Fair</p>
                                    </div>
                                </div>
                            </div>
                            <div className='w-full bg-white mb-10 lg:mb-0'>
                                <div className='relative'>
                                    ...
                                    <div className='absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 text-white'>
                                        <p className='text-2xl font-bold'>AI & Cardiometabolic Health Capacity/Readiness Survey</p>
                                    </div>
                                </div>
                            </div>
                            <div className='w-full bg-white mb-10 lg:mb-0'>
                                <div className='relative'>
                                    <img className='w-full' src={r4} alt="Advocacy Action Research: Food Insecurity" />
                                    <div className='absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 text-white'>
                                        <p className='text-2xl font-bold'>Advocacy Action Research: Food Insecurity</p>
